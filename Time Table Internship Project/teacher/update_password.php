...
if (isset($_POST['edit'])) {
    ...
    if ($oldpassword != $user_data['password']) {
        ...
        $update_query = "UPDATE teachers SET password='$newpassword' WHERE teacher_id = '$teacher_id'";
    ...
    <section class="addstudent">
        ...
        <section class="form-container">
            ...
            <form action="" method="post" enctype="multipart/form-data">
                <input type="hidden" name="teacher_id" value="<?php echo $user_data['teacher_id']; ?>">
